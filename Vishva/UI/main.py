...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.color_30_secondary = "#1A1A2E" # Updated secondary color for better matching
        ...
        for i, (icon, name) in enumerate(nav_items):
            container = QWidget(); lay = QVBoxLayout(container); lay.setContentsMargins(0,0,0,0)
    ...
    def setup_notes(self):
        ...
        t_lay.setContentsMargins(15, 25, 15, 25) # Standardized vertices padding
        ...
        tone.setStyleSheet("background: #1A1D2E; color: white; border-radius: 8px; padding: 10px;"); t_lay.addWidget(tone)
        
        t_lay.addStretch()
        gen_btn = GlowButton("✨ GENERATE", self.color_10_accent)
        gen_btn.setMinimumHeight(55) # Enhanced width and padding feel
        t_lay.addWidget(gen_btn)
    ...
    def setup_quiz(self):
        ...
        # RESTORED: Quiz Sidebar Controls
        ...
        c_lay.addSpacing(20)
        c_lay.addWidget(QLabel("QUESTIONS COUNT", styleSheet="color: white; font-size: 10px;"))
        spin = QSpinBox(); spin.setRange(5, 50); spin.setValue(10)
        spin.setStyleSheet("background: #1A1D2E; color: white; border-radius: 8px; padding: 10px;")
        c_lay.addWidget(spin)
        
        c_lay.addSpacing(20)
        for opt in ["Multiple Choice", "True/False", "Key Concepts", "Fill Blanks"]:
            chk = QCheckBox(opt); chk.setStyleSheet("color: #A78BFA; font-size: 11px;")
            c_lay.addWidget(chk)
    ...
    def setup_calendar(self):
        ...
        # UPDATED: Calendar Header color palette matching (Indigo tone)
        cal.setStyleSheet(f"""
            ...
            QCalendarWidget QWidget#qt_calendar_navigationbar {{ 
                ...
                min-height: 85px; padding: 10px; border-bottom: 1px solid rgba(139, 92, 246, 0.2);
            }}
            QCalendarWidget QToolButton {{ color: white; font-weight: bold; background: transparent; height: 40px; width: 110px; border-radius: 8px; }}
            QCalendarWidget QToolButton:hover {{ background: rgba(139, 92, 246, 0.3); }}
            QCalendarWidget QSpinBox {{ background: #1A1D2E; color: white; width: 65px; border-radius: 5px; }}
        """)
